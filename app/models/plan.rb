class Plan < ApplicationRecord
  ...
  def add_default_items
    ...
    self.items.create!(name: 'Freezer', watts: 100, hours: 8, priority: need)    
    self.items.create!(name: 'Fan', watts: 40, hours: 12, priority: need)
    ...
    self.items.create!(name: 'AC', watts: 500, hours: 6, priority: lux)
    self.items.create!(name: 'Clothes Dryer', watts: 1500, hours: 1, priority: lux)    
    self.items.create!(name: 'Coffee', watts: 1000, hours: 1, priority: lux)    
